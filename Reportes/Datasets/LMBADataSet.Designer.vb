...
Namespace LMBADataSetTableAdapters
    ...
    Partial Public Class HorarioTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(2).CommandText = "SELECT idHorario, nombre, horaEntrada, horaSalida FROM dbo.Horario WHERE (nombre "& _ 
                "like @nombre)"
            ...
            Me._commandCollection(3).CommandText = "INSERT INTO [dbo].[Horario] ([nombre], [horaEntrada], [horaSalida]) VALUES (@nomb"& _ 
                "re, @horaEntrada, @horaSalida);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT idHorario, nombre, horaEntrada, horaSali"& _ 
                "da FROM Horario WHERE (idHorario = SCOPE_IDENTITY())"
            ...
            Me._commandCollection(4).CommandText = "UPDATE [dbo].[Horario] SET [nombre] = @nombre, [horaEntrada] = @horaEntrada, [hor"& _ 
                "aSalida] = @horaSalida WHERE (([idHorario] = @Original_idHorario));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)
        ...
        Public Overloads Overridable Function InsertHorario(ByVal nombre As String, ByVal horaEntrada As String, ByVal horaSalida As String) As Integer
        ...
        Public Overloads Overridable Function UpdateHorario(ByVal nombre As String, ByVal horaEntrada As String, ByVal horaSalida As String, ByVal Original_idHorario As Integer) As Integer
    ...
    Partial Public Class tbl_userTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(2).CommandText = "SELECT id_user, username, pwd, nombres, apellidos, pwd_temp, email, estado FROM d"& _ 
                "bo.tbl_user WHERE (username like @username)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(4) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(4).Connection = Me.Connection
            Me._commandCollection(4).CommandText = "UPDATE [dbo].[tbl_user] SET  [pwd] = @pwd WHERE (([id_user] = @Original_id_user))"& _ 
                ";"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id_user, username, pwd, nombres, apellidos, pwd_temp, email, estado FR"& _ 
                "OM tbl_user WHERE (id_user = @id_user)"
            Me._commandCollection(4).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(4).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@id_user", Global.System.Data.SqlDbType.Int, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "id_user", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, false)>  _
        Public Overloads Overridable Function UpdateUser(ByVal pwd As String, ByVal Original_id_user As Integer, ByVal id_user As Integer) As Integer
            Dim command As Global.System.Data.SqlClient.SqlCommand = Me.CommandCollection(4)
            If (pwd Is Nothing) Then
                Throw New Global.System.ArgumentNullException("pwd")
            Else
            ...
            command.Parameters(2).Value = CType(id_user,Integer)
            Dim previousConnectionState As Global.System.Data.ConnectionState = command.Connection.State
            If ((command.Connection.State And Global.System.Data.ConnectionState.Open)  _
                        <> Global.System.Data.ConnectionState.Open) Then
                command.Connection.Open
