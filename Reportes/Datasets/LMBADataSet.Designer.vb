...
Partial Public Class LMBADataSet
    ...
    Partial Public Class CargoDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddCargoRow(ByVal nombreCargo As String, ByVal descripcion As String, ByVal estado As Boolean, ByVal parentDepartamentoRowByRefDepartamento1 As DepartamentoRow) As CargoRow
            Dim rowCargoRow As CargoRow = CType(Me.NewRow,CargoRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, nombreCargo, descripcion, estado, Nothing}
    ...
    Partial Public Class CargoTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cargo] WHERE (([idCargo] = @Original_idCargo) AND ([nombreCarg"& _ 
                "o] = @Original_nombreCargo) AND ([descripcion] = @Original_descripcion) AND ([es"& _ 
                "tado] = @Original_estado) AND ([idDepartamento] = @Original_idDepartamento))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cargo] ([nombreCargo], [descripcion], [estado], [idDepartament"& _ 
                "o]) VALUES (@nombreCargo, @descripcion, @estado, @idDepartamento);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT idCar"& _ 
                "go, nombreCargo, descripcion, estado, idDepartamento FROM Cargo WHERE (idCargo ="& _ 
                " SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Cargo] SET [nombreCargo] = @nombreCargo, [descripcion] = @descripci"& _ 
                "on, [estado] = @estado, [idDepartamento] = @idDepartamento WHERE (([idCargo] = @"& _ 
                "Original_idCargo) AND ([nombreCargo] = @Original_nombreCargo) AND ([descripcion]"& _ 
                " = @Original_descripcion) AND ([estado] = @Original_estado) AND ([idDepartamento"& _ 
                "] = @Original_idDepartamento));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT idCargo, nombreCargo, descripcion, estad"& _ 
                "o, idDepartamento FROM Cargo WHERE (idCargo = @idCargo)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT idCargo, nombreCargo, descripcion, estado, idDepartamento FROM dbo.Cargo"
