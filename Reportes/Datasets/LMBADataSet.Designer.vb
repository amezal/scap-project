...
Namespace LMBADataSetTableAdapters
    ...
    Partial Public Class tbl_userTableAdapter
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, false)>  _
        Public Overloads Overridable Function InsertUser(ByVal pwd As String) As Integer
            Dim command As Global.System.Data.SqlClient.SqlCommand = Me.CommandCollection(3)
            If (pwd Is Nothing) Then
                Throw New Global.System.ArgumentNullException("pwd")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, false)>  _
        Public Overloads Overridable Function UpdateUser(ByVal pwd As String, ByVal Original_id_user As Integer) As Integer
            Dim command As Global.System.Data.SqlClient.SqlCommand = Me.CommandCollection(4)
            If (pwd Is Nothing) Then
                Throw New Global.System.ArgumentNullException("pwd")
            Else
                command.Parameters(0).Value = CType(pwd,String)
            End If
            command.Parameters(1).Value = CType(Original_id_user,Integer)
            Dim previousConnectionState As Global.System.Data.ConnectionState = command.Connection.State
            If ((command.Connection.State And Global.System.Data.ConnectionState.Open)  _
                        <> Global.System.Data.ConnectionState.Open) Then
                command.Connection.Open
    ...
    Partial Public Class EmpleadosDgvTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT        Empleado.idEmpleado AS ID, Empleado.numCedula AS Cedula, { fn CONCA"& _ 
                ...
                "         Empleado INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(10)&"                         Cargo ON Empleado.idCargo "& _ 
                "= Cargo.idCargo INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(10)&"                         Departamento ON Cargo.idDepa"& _ 
                "rtamento = Departamento.idDepartamento"&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        ({ fn CONCAT(Empleado.primer"& _ 
                "Nombre, (CASE WHEN (segundoNombre IS NULL) THEN '' ELSE CONCAT(' ', segundoNombr"& _ 
                "e) END)) } LIKE @nombres)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
